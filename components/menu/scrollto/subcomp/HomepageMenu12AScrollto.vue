<template>
  <div class="yjb">
    <div class="disable">
      <Homepage12AScrolltoShared id="child" class="child" />
    </div>
  </div>
</template>
...
<script>
// prettier-ignore
import Homepage12AScrolltoShared from '~/components/shared/Homepage12AScrolltoShared.vue'

export default {
  components: {
    Homepage12AScrolltoShared
  }
}
</script>
