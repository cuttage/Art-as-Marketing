      ...
      <div class="declaration declaration1">
        <div class="text">
          <div id="target-d1 tI" class="t6e dyb">‘Minimal structure’: Fast adapted.
            ...
            <div class="wi6">
              <div class="v8u tI">Your customer may prefer an epic scenic soundtrack</div>
              <div class="xru tI">or music accompanying their movements</div>
        ...
        <div class="text">
          <div id="target-d1 tI" class="title-subcomp-d6 title-d3var">‘Minimal structure’: Fast adapted.
            ...
            <div class="container-subtitle2-d6">
              <div class="subtitle2A-d6 tI">Your customer may prefer an epic scenic soundtrack</div>
              <div class="subtitle21-d6 tI">or music accompanying their movements</div>
