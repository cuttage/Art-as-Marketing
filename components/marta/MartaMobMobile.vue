<template>
<<<<<<< HEAD:components/awidget/ArticleWidgetMob.vue
  <div class="0og">
    <div class="7uh fxw">
      <div class="go3">
        <small class="k9z">
...
=======
  <div class="container-marta">
    <div class="panel-container text-marta">
      <div class="container-subheader-reg-text-reg-text-sub">
        <small class="temp1">
          Marta Fattori
        </small>
...
>>>>>>> parent of 494e274... Changed mostly class naming system, intermediate step:components/marta/MartaMobMobile.vue
      </div>
    </div>
  </div>
</template>
...
.container-marta .container-subheader-reg-text-reg-text-sub {
>>>>>>> parent of 494e274... Changed mostly class naming system, intermediate step:components/marta/MartaMobMobile.vue
  will-change: opacity;
  opacity: 0.3;
}
...
<<<<<<< HEAD:components/awidget/ArticleWidgetMob.vue
  ...
  &:hover .go3 {
=======
  &:focus .container-subheader-reg-text-reg-text-sub,
  &:hover .container-subheader-reg-text-reg-text-sub {
>>>>>>> parent of 494e274... Changed mostly class naming system, intermediate step:components/marta/MartaMobMobile.vue
    opacity: 1;
...
.panel-container small:nth-of-type(2)  {
>>>>>>> parent of 494e274... Changed mostly class naming system, intermediate step:components/marta/MartaMobMobile.vue
	text-transform: uppercase;
  opacity: 0.6;
}
...
.k9z {
=======
.panel-container small:nth-of-type(1)  {
  opacity: 1;
}
