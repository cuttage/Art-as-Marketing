...
/*@media only screen and (min-width: 368px) and (max-width: 569px) and (orientation: landscape) {
  .A-absolutely.n3 {
    height: calc(16.019932707939257rem + 25px + 1.151rem) !important;
    min-height: calc(16.019932707939257rem + 25px + 1.151rem) !important;
  }
}*/
.help-enabler {
  flex-grow: 1;
...
@media only screen and (max-height: 460px) and (orientation: landscape) {
  ...
  .container-d1.d3 {
    max-height: none !important; /* was max-height: 50px 1vw; */
    margin-bottom: calc(13.107868538905315rem + 25px + 2rem - 100vh - 50px -
    (((100vh / 2) - (13.107868538905315rem / 2)) * -1)) !important;
  }
  .container-d1.e3 {
    max-height: none !important; /* was max-height: 50px 1vw; */
  ...
  @media only screen and (min-width: 420px) and (max-width: 569px) and (orientation: landscape) {
    .container-d1.c3 {
      max-height: none !important; /* was max-height: 50px 1vw; */
      margin-bottom: calc(16.019932707939257rem + 25px + 1.151rem - 100vh - 50px -
      (((100vh / 2) - (16.019932707939257rem / 2)) * -1)) !important;
    }
  }
}
</style-->
