  ...
  <div>
    ...
    <main v-if="selectedContent" class="rchv" id="mzp1" v-pan="onPan">
      ...
      <article class="article">
        ...
        <Homepage11AScrollto v-if="isHomepage1DialogActive" class="A-bs n1" />


        <Homepage12AScrollto v-if="isHomepage2DialogActive" class="A-bs n2" />
        ...
        <Homepage14AScrollto v-if="isHomepage4DialogActive" class="A-bs n4" />
      ...
      <article class="article">
        ...
        <div class="cosa" ref="cosa" v-if="selectedContent">
           {{ selectedContent }}
        </div>


        <div class="cosa nwcs" ref="cosa" v-else>
      ...
      <main
        v-if="isHomepage1DialogActive && selected2 === '+ Help'"
        class="rchv"
        id="mzpb"
      >
...
export default {
  ...
  data() {
    return {
      ...
      indices: ['Surprise', 'Challenge', 'Bravery', 'Levity', 'Narrowing Down'],
      cosas: [
  ...
  computed: {
    ...
    isAnyActive() {
      return (
        this.isHomepage1DialogActive ||
        this.isHomepage2DialogActive ||
        this.isHomepage3DialogActive ||
        this.isHomepage4DialogActive ||
        this.isHomepage5DialogActive
      )
    },
    overflowRatio() {
  ...
  methods: {
    ...
    onTap(e, value) {
      if (value) {
        ...
        this.selected = value
        if (this.selected !== 'Surprise' && this.selected2 !== '– Help')
          this.selected2 = '– Help'
      }
    },
    async utilA() {
  ...
  async created() {
    this.wchrSubtouch1A = this.$watch(
      'selected2',
      async (newValue, oldValue) => {
        if (newValue === '+ Help') await this.utilA()
        if (newValue === '– Help' && this.getToggleHelp?.value === true)
  ...
  beforeDestroy() {
    this.wchrSubtouch1A()
    if (this.getToggleHelp?.value === true) this.toggleHelp()
  },
}
</script>
