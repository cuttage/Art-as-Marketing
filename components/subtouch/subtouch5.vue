  ...
  <div>
    ...
    <main v-if="selectedContent" class="rchv" id="mzp1" v-pan="onPan">
      ...
      <article class="article">
        ...
        <Homepage11EScrollto v-if="isHomepage1DialogActive" class="A-bs n1" />


        <Homepage12EScrollto v-if="isHomepage2DialogActive" class="A-bs n2" />
        ...
        <Homepage14EScrollto v-if="isHomepage4DialogActive" class="A-bs n4" />
...
export default {
  ...
  async created() {
    this.wchrSubtouch1C = this.$watch(
      'selected2',
