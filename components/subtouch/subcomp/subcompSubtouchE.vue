<template>
  <div>
<<<<<<< HEAD:components/subtouch/subcomp/SSubtouchE.vue
    <main v-if="selectedContent" class="3wp" id="lt3" v-pan="onPan">
      <article class="article">
        ...
        <Homepage15Target
          ...
          class="ruj n0"
=======
    <main v-if="selectedContent" class="archive" id="mappSubcompSubtouch1" v-pan="onPan">
      <article class="article">
        <Homepage11Target
          v-if="isHomepage1DialogActive"
          class="A-absolutely n0"
        />
        <Homepage12TargetEmployeesNowrap
          v-if="isHomepage2DialogActive"
          class="A-absolutely alternative"
        />
        <Homepage13Target
          v-if="isHomepage3DialogActive"
          class="A-absolutely n0"
        ...
        <Homepage15Target
          v-if="isHomepage5DialogActive"
          class="A-absolutely n0"
>>>>>>> parent of 494e274... Changed mostly class naming system, intermediate step:components/subtouch/subcomp/subcompSubtouchE.vue
        />
      </article>

      <article class="article">
<<<<<<< HEAD:components/subtouch/subcomp/SSubtouchE.vue
        <FormMob class="fnm" v-if="selectedContent" />
=======
        <MyFormMob class="contact-form-container" v-if="selectedContent" />
>>>>>>> parent of 494e274... Changed mostly class naming system, intermediate step:components/subtouch/subcomp/subcompSubtouchE.vue
      </article>
      <article class="article">
    ...
    <main v-else class="3wp wud ybl" id="lt3" v-pan="onPan">
      <article class="article">
        ...
        <Homepage15Target
          ...
          class="ruj n0"
=======
    <main v-else class="archive specificarchive newmapp1" id="mappSubcompSubtouch1" v-pan="onPan">
      <article class="article">
        <Homepage11Target
          v-if="isHomepage1DialogActive"
          class="A-absolutely n0"
...
import MyFormMob from '~/components/MyFormMob.vue'
