<template>
  <div>
<<<<<<< HEAD:components/subtouch/subcomp/SSubtouchA.vue
    ...
    <main v-if="selectedContent" class="archive" id="mappSubcompSubtouch1" v-pan="onPan">
      <article class="article">
        ...
        <Homepage14Target
          v-if="isHomepage5DialogActive"
          class="A-absolutely n0"
>>>>>>> parent of 494e274... Changed mostly class naming system, intermediate step:components/subtouch/subcomp/subcompSubtouchA.vue
        />
      </article>
