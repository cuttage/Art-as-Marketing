<template>
  <div>
    <main v-if="selectedContent" class="archive" id="mapp1" v-pan="onPan">
      ...
      <!--new section-->
      <article class="article">
        <subcompSubtouchA v-if="isAnyActive" />
      </article>
    </main>
...
import subcompSubtouchA from '~/components/subtouch/subcomp/subcompSubtouchA.vue'
...
@media only screen and (max-height: 460px) and (orientation: landscape) {
  ...
  .container-d1.b4 {
    max-height: none !important; /* was max-height: 50px 1vw; */
    margin-bottom: calc(18.191162810517213rem + 25px + 1.151rem - 100vh - 50px -
    (((100vh / 2) - (18.191162810517213rem / 2)) * -1)) !important;
  }
  .container-d1.c4 {
    max-height: none !important; /* was max-height: 50px 1vw; */
