<template>
<<<<<<< HEAD:components/slots/desktop/InputParent.vue
...
>>>>>>> parent of 494e274... Changed mostly class naming system, intermediate step:components/slots/desktop/InputParentDesk.vue
    </article>
...
export default {
  ...
  components: {
    project: () => import("~/components/logomob/project.vue")
  },
  computed: {
    ...mapState({
      page: 'page'
