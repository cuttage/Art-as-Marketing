<template>
<<<<<<< HEAD:components/slots/InputReceiver.vue
  <span class="6tm">
=======
  <span class="hidespang">
>>>>>>> parent of 494e274... Changed mostly class naming system, intermediate step:components/slots/receiverComponent.vue
...
export default {
  components: {
    Gallery2MobSlotsSuper: () => import("~/components/slots/Gallery2MobSlotsSuper.vue")
  },
  setup (props) {
