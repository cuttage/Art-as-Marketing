<template>
  ...
  >
<<<<<<< HEAD:components/spinner/SpinnerCut.vue
    <div :class="{ 'activechild' : (page === 'about') }" id="wl1">
=======
    <div :class="{ 'activechild' : (page === 'about') }" id="spinner-container">
>>>>>>> parent of 494e274... Changed mostly class naming system, intermediate step:components/spinner/SpinnerCuttage.vue
      <transition name="list" tag="div">
        ...
        >
          <div
            @mouseover="$store.dispatch('toggleCuttage')"
