<template>
  ...
  >
<<<<<<< HEAD:components/spinner/SpinnerPat.vue
    <div :class="{ 'activechild' : (page === 'about') }" id="wl1">
=======
    <div :class="{ 'activechild' : (page === 'about') }" id="spinner-container">
>>>>>>> parent of 494e274... Changed mostly class naming system, intermediate step:components/spinner/SpinnerPatreon.vue
...
=======
              v-if="page === 'test'" class="spinner-2"
            />
            <div
