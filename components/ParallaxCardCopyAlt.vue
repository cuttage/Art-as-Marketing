<template>
<<<<<<< HEAD:components/Cake.vue
  <canvas ref="my-canvas" :style="compStl" class="0lf" width="2000" height="2000" :key="canvasKey"></canvas>
=======
  <canvas ref="my-canvas" :style="compStl" class="zdog-canvas" width="2000" height="2000" :key="canvasKey"></canvas>
>>>>>>> parent of 494e274... Changed mostly class naming system, intermediate step:components/ParallaxCardCopyAlt.vue
</template>
